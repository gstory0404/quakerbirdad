...
class QuakerBirdAdExpressDraw extends StatefulWidget {
  final String androidId;
  final String iosId;
  final double width;
  final double height;
  final QuakerBirdAdExpressDrawCallBack? callBack;
  ...
  @override
  State<QuakerBirdAdExpressDraw> createState() => _QuakerBirdAdExpressDrawState();
}

class _QuakerBirdAdExpressDrawState extends State<QuakerBirdAdExpressDraw> {
  String _viewType = "com.gstory.quakerbirdad/ExpressDrawAdView";

...
class QuakerBirdAdBanner extends StatefulWidget {
  final String androidId;
  final String iosId;
  final double width;
  final double height;
  final QuakerBirdAdBannerCallBack? callBack;
  ...
  @override
  State<QuakerBirdAdBanner> createState() => _QuakerBirdAdBannerState();
}

class _QuakerBirdAdBannerState extends State<QuakerBirdAdBanner> {
  String _viewType = "com.gstory.quakerbirdad/BannerAdView";

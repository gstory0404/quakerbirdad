...
class QuakerBirdAdFeed extends StatefulWidget {
  final String androidId;
  final String iosId;
  final double width;
  final double height;
  final QuakerBirdAdFeedCallBack? callBack;
  ...
  @override
  State<QuakerBirdAdFeed> createState() => _QuakerBirdAdFeedState();
}

class _QuakerBirdAdFeedState extends State<QuakerBirdAdFeed> {
  String _viewType = "com.gstory.quakerbirdad/FeedAdView";

...
class QuakerBirdAdExpress extends StatefulWidget {
  final String androidId;
  final String iosId;
  final double width;
  final double height;
  final QuakerBirdAdExpressCallBack? callBack;
  ...
  @override
  State<QuakerBirdAdExpress> createState() => _QuakerBirdAdExpressState();
}

class _QuakerBirdAdExpressState extends State<QuakerBirdAdExpress> {
  String _viewType = "com.gstory.quakerbirdad/ExpressAdView";

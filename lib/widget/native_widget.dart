...
class QuakerBirdAdNative extends StatefulWidget {
  final String androidId;
  final String iosId;
  final double width;
  final double height;
  final QuakerBirdAdNativeCallBack? callBack;
  ...
  @override
  State<QuakerBirdAdNative> createState() => _QuakerBirdAdFeedState();
}

class _QuakerBirdAdFeedState extends State<QuakerBirdAdNative> {
  String _viewType = "com.gstory.quakerbirdad/NativeAdView";

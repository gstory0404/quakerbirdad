package com.gstory.quakerbirdad.interactionad
...
object InteractionAd {
    ...
    private fun loadInteractionAd() {
        adClient.requestInteractionAd(mCodeId, object : AdLoadAdapter() {
            /**
             * 广告信息加载成功回调
             */
            ...
            override fun onError(p0: Int, p1: String?) {
                ...
                QuakerBirdAdEvent.sendContent(mutableMapOf("adType" to "interactionAd", "onAdMethod" to "onError", "msg" to p1))
            }
            ...
            override fun onStatus(p0: Int, p1: Int, p2: Int, p3: String?) {
                ...
                QuakerBirdAdEvent.sendContent(mutableMapOf("adType" to "interactionAd", "onAdMethod" to "onStatus", "type" to p0, "platform" to p1, "status" to p2, "msg" to p3))
            }
        })
    }
}